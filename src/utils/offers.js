const getChangedByTypeOffers = (allOffers, currentType) => {
  let offersByType = {};
...
const createOffersSectionMarkup = (offers, pointType) => {
...
const changeCheckedOffers = (offers, checkedOffer) => {
...
export {getChangedByTypeOffers, createOffersSectionMarkup, changeCheckedOffers};
