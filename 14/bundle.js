...
class PointPresenter {
  constructor(pointsListElement, chageData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_TASK, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, { ..._classPrivateFieldGet(this, _tripPoint),
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: point => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_TASK, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, point);
...
/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/const */ "./src/utils/const.js");
...
class TripPresenter {
  constructor(mainElement, pointsModel) {
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_const__WEBPACK_IMPORTED_MODULE_5__.SortType.SORT_DAY
    });
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UserAction.UPDATE_TASK:
            _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UserAction.ADD_TASK:
            _classPrivateFieldGet(this, _pointsModel).addPoint(updateType, update);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UserAction.DELETE_TASK:
    ...
    _classPrivateFieldInitSpec(this, _handleModelEvent, {
      ...
      value: (updateType, data) => {
        switch (updateType) {
          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UpdateType.PATCH:
            _classPrivateFieldGet(this, _pointPresenter).get(data.id).init(data);

            break;

          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UpdateType.MINOR:
          ...
          case _utils_const__WEBPACK_IMPORTED_MODULE_5__.UpdateType.MAJOR:
            _classPrivateFieldGet(this, _clearMain).call(this, {
    ...
    _classPrivateFieldInitSpec(this, _handleSortTypeChange, {
      ...
      value: sortType => {
        ...
        _classPrivateFieldGet(this, _renderTripPointsList).call(this, this.points);
    ...
    _classPrivateFieldInitSpec(this, _renderTripPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _tripPointsListComponent), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _clearMain, {
      ...
      value: ({
        ...
        TripPresenter.remove(_classPrivateFieldGet(this, _sortComponent));
        TripPresenter.remove(_classPrivateFieldGet(this, _noTripsComponent));

        if (resetSortType) {
          _classPrivateFieldSet(this, _currentSortType, _utils_const__WEBPACK_IMPORTED_MODULE_5__.SortType.SORT_DAY);
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderMain, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _renderTripPointsList).call(this, points);
      }
    });
  ...
  get points() {
    switch (_classPrivateFieldGet(this, _currentSortType)) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_5__.SortType.SORT_DAY:
        return [..._classPrivateFieldGet(this, _pointsModel).points].sort(_utils_point__WEBPACK_IMPORTED_MODULE_6__.sortTaskByDay);

      case _utils_const__WEBPACK_IMPORTED_MODULE_5__.SortType.SORT_TIME:
        return [..._classPrivateFieldGet(this, _pointsModel).points].sort(_utils_point__WEBPACK_IMPORTED_MODULE_6__.sortTaskByDuration);

      case _utils_const__WEBPACK_IMPORTED_MODULE_5__.SortType.SORT_PRICE:
        return [..._classPrivateFieldGet(this, _pointsModel).points].sort(_utils_point__WEBPACK_IMPORTED_MODULE_6__.sortTaskByPrice);
    }
...
/* harmony import */ var _view_trip_tabs_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/trip-tabs-view.js */ "./src/view/trip-tabs-view.js");
...
/* harmony import */ var _mock_event_types_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mock/event-types.js */ "./src/mock/event-types.js");
...
}, _mock_event_types_js__WEBPACK_IMPORTED_MODULE_4__.eventTypes);
...
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripControlsFiltersElement, new _view_trip_filters_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripControlsNavigationElement, new _view_trip_tabs_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_3__["default"](pageMainElement, pointsModel);
tripPresenter.init();
})();
